...
data class TrialEntity(
    ...
    val gameType: String = "CHORD_TYPE",    // CHORD_TYPE, CHORD_FUNCTION, CHORD_PROGRESSION, INTERVAL, or SCALE
    ...
    val answeredScale: String? = null       // What user answered for scale game (null = correct or N/A)
)
